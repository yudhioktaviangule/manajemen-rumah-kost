...
@section('judul','Input Data Item Pemeliharaan')
@section('content')
<div class="col-md-6 col-md-offset-3">
    <form class="box" action="{{route('pemeliharaan.store')}}" method="POST">
        @csrf
      <div class="box-header with-border">
        <h3 class="box-title">Item Pemeliharaan</h3>
      ...
      <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="jenis_pemeliharaan" placeholder="">
            </div>
            <div class="form-group">
