...
@section('judul','Perawatan')
@section('content')
<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Daftar Item Perawatan</h3>
    <div class="box-tools pull-right">
      <a href="{{ route('perawatan.create') }}" class="btn btn-primary btn-sm">
          Tambah Item Perawatan
      </a>
    </div>
    <!-- /.box-tools -->
  </div>
    ...
    <script>
            $(document).ready(()=>{
                ...
                $("#dt").DataTable({
                    ...
                    serverSide:true,
                    ajax:{
                        url:"{{route('api.datatable.perawatan')}}",
                    }
                });
