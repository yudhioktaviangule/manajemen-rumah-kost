...
<head>
  ...
  <title>{{config('app.name','Lara')}} | {{Auth::user()->name}}</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/home')}}" class="logo">
      ...
      <span class="logo-mini"><b>{{config('app.singkatan_bold')}}</b>{{config('app.singkatan_tipis')}}</span>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                @php
                    $lvl = Auth::user()->level;
                    $lvl = $lvl=='admin'?"Administrator":"Penghuni Kamar";
                    $carbx = \Carbon\Carbon::class;
                    $member = $carbx::parse(Auth::user()->created_at)->diffForHumans();
                @endphp
                <p>
                  {{Auth::user()->name}} - {{$lvl}}
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="#" onclick="logot()" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{ Auth::user()->name }}</p>
          <!-- Status -->
          <a href="#"><i class="fa fa-circle text-success"></i>{{$lvl}}</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>{{ucfirst(strtolower(Auth::user()->name))}}</small>
      </h1>
      <ol class="breadcrumb">
